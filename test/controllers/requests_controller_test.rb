...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { trap_id: @request.trap_id, request: @request.request } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { trap_id: @request.trap_id, request: @request.request } }
