Rails.application.routes.draw do  
 ...
 #  resources :traps do
	...
	# end
get    ':trap_id/requests',     to:    'requests#index',   as: 'trap_requests'
get    ':trap_id/requests/:id', to:    'requests#show',    as: 'trap_request'
delete ':trap_id/requests/:id', to:    'requests#destroy'
